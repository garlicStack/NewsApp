package com.d4f.myfeed.yalantis.flipviewpager.adapter;
...
import com.d4f.myfeed.yalantis.flipviewpager.utils.FlipSettings;
import com.d4f.myfeed.yalantis.flipviewpager.view.FlipViewPager;
...
public abstract class BaseFlipAdapter<T> extends BaseAdapter {
    ...
    public BaseFlipAdapter(Context context, List<Topic> items, FlipSettings settings) {
        this.items = items;
